...
var NB_CORE_PROVIDERS = __WEBPACK_IMPORTED_MODULE_4__data_data_module__["a" /* DataModule */].forRoot().providers.concat(__WEBPACK_IMPORTED_MODULE_2__nebular_auth__["b" /* NbAuthModule */].forRoot({
    providers: {
        email: {
            service: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["d" /* NbDummyAuthProvider */],
            config: {
                delay: 3000,
                login: {
                    rememberMe: true,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__transactions_service__ = __webpack_require__("../../../../../src/app/@core/data/transactions.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__rules_service__ = __webpack_require__("../../../../../src/app/@core/data/rules.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__passports_service__ = __webpack_require__("../../../../../src/app/@core/data/passports.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__users_service__ = __webpack_require__("../../../../../src/app/@core/data/users.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__electricity_service__ = __webpack_require__("../../../../../src/app/@core/data/electricity.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__state_service__ = __webpack_require__("../../../../../src/app/@core/data/state.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__smart_table_service__ = __webpack_require__("../../../../../src/app/@core/data/smart-table.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__player_service__ = __webpack_require__("../../../../../src/app/@core/data/player.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SERVICES = [
    __WEBPACK_IMPORTED_MODULE_2__transactions_service__["a" /* TransactionsService */],
    __WEBPACK_IMPORTED_MODULE_3__rules_service__["a" /* RulesService */],
    __WEBPACK_IMPORTED_MODULE_4__passports_service__["a" /* PassportsService */],
    __WEBPACK_IMPORTED_MODULE_5__users_service__["a" /* UserService */],
    __WEBPACK_IMPORTED_MODULE_6__electricity_service__["a" /* ElectricityService */],
    __WEBPACK_IMPORTED_MODULE_7__state_service__["a" /* StateService */],
    __WEBPACK_IMPORTED_MODULE_8__smart_table_service__["a" /* SmartTableService */],
    __WEBPACK_IMPORTED_MODULE_9__player_service__["a" /* PlayerService */],
];
...
/***/ "../../../../../src/app/@core/data/passports.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PassportsService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
var PassportsService = /** @class */ (function () {
    function PassportsService(http) {
        this.http = http;
    }
    /**
     * 許可証を発行する
     * @param target 発行対象
     */
    PassportsService.prototype.issue = function (target) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].endpoint + "/passports", target, httpOptions)
            .map(function (passport) { return passport; })
     ...
     * @param target 発行対象
     */
    PassportsService.prototype.getCurrentIssueUnit = function (target) {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].endpoint + "/passports/" + target.scope + "/currentIssueUnit", httpOptions)
     ...
     */
    PassportsService.prototype.handleError = function (error) {
        // TODO: send the error to remote logging infrastructure
        console.error(error); // log to console instead
        return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].throw(error);
    };
    PassportsService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */]])
    ], PassportsService);
    return PassportsService;
}());
...
/***/ "../../../../../src/app/@core/data/rules.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var RulesService = /** @class */ (function () {
    ...
    RulesService.prototype.getAll = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].endpoint + "/rules", httpOptions)
            .map(function (clients) { return clients; })
            .catch(this.handleError);
    };
    /**
     * Handle Http operation that failed.
...
/***/ "../../../../../src/app/@core/data/transactions.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var TransactionsService = /** @class */ (function () {
     ...
     */
    TransactionsService.prototype.searchPlaceOrder = function (conditions) {
        return this.http.get('/api/transactions/placeOrder', __assign({}, httpOptions, { params: conditions }))
            .map(function (transactions) { return transactions; })
            .catch(this.handleError);
    };
    /**
     * IDで注文取引を検索する
     * @param id 取引ID
     */
    TransactionsService.prototype.findPlaceOrderById = function (id) {
        return this.http.get("/api/transactions/placeOrder/" + id, httpOptions)
            .map(function (transaction) { return transaction; })
            .catch(this.handleError);
    };
    /**
     * Handle Http operation that failed.
...
var UserService = /** @class */ (function () {
    function UserService() {
        this.users = {
            tetsu: { name: 'Tetsu Yamazaki', picture: 'assets/images/tetsu.png' },
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.userService.getUsers()
            .subscribe(function (users) { return _this.user = users.tetsu; });
    };
...
var BASE_MODULES = [__WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["k" /* ReactiveFormsModule */]];
var NB_MODULES = [
    __WEBPACK_IMPORTED_MODULE_5__nebular_theme__["b" /* NbCardModule */],
    __WEBPACK_IMPORTED_MODULE_5__nebular_theme__["d" /* NbLayoutModule */],
    __WEBPACK_IMPORTED_MODULE_5__nebular_theme__["l" /* NbTabsetModule */],
    __WEBPACK_IMPORTED_MODULE_5__nebular_theme__["h" /* NbRouteTabsetModule */],
    __WEBPACK_IMPORTED_MODULE_5__nebular_theme__["f" /* NbMenuModule */],
    __WEBPACK_IMPORTED_MODULE_5__nebular_theme__["o" /* NbUserModule */],
    __WEBPACK_IMPORTED_MODULE_5__nebular_theme__["a" /* NbActionsModule */],
    __WEBPACK_IMPORTED_MODULE_5__nebular_theme__["i" /* NbSearchModule */],
    __WEBPACK_IMPORTED_MODULE_5__nebular_theme__["j" /* NbSidebarModule */],
...
var NB_THEME_PROVIDERS = __WEBPACK_IMPORTED_MODULE_5__nebular_theme__["m" /* NbThemeModule */].forRoot({
    name: 'cosmic',
}, [__WEBPACK_IMPORTED_MODULE_9__styles_theme_default__["a" /* DEFAULT_THEME */], __WEBPACK_IMPORTED_MODULE_10__styles_theme_cosmic__["a" /* COSMIC_THEME */]]).providers.concat(__WEBPACK_IMPORTED_MODULE_5__nebular_theme__["j" /* NbSidebarModule */].forRoot().providers, __WEBPACK_IMPORTED_MODULE_5__nebular_theme__["f" /* NbMenuModule */].forRoot().providers);
var ThemeModule = /** @class */ (function () {
    ...
    ThemeModule = ThemeModule_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: BASE_MODULES.concat(NB_MODULES, MATERIAL_MODULES),
            exports: BASE_MODULES.concat(NB_MODULES, COMPONENTS, PIPES, MATERIAL_MODULES),
...
var routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: '',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["e" /* NbLoginComponent */],
            },
            {
                path: 'login',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["e" /* NbLoginComponent */],
            ...
            {
                path: 'register',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["g" /* NbRegisterComponent */],
            },
            {
                path: 'logout',
            ...
            },
            {
                ...
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["h" /* NbRequestPasswordComponent */],
            },
            {
                path: 'reset-password',
                component: __WEBPACK_IMPORTED_MODULE_2__nebular_auth__["i" /* NbResetPasswordComponent */],
            },
        ],
    },
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__nebular_auth__["c" /* NbAuthService */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]])
    ], AuthGuard);
    return AuthGuard;
}());
...
var environment = {
    ...
    endpoint: 'https://sskts-waiter-development.appspot.com',
};
